...
function ECB(count, dataCodewords) {
    ...
    this.getDataCodewords = function() { return dataCodewords; }
...
function ECBlocks(ecCodewordsPerBlock, ecBlocks1, ecBlocks2) {
    ...
    var ecBlocks = [];
    ecBlocks.push(ecBlocks1);
    if( arguments.length > 2 ) ecBlocks.push(ecBlocks2);

    this.getECCodewordsPerBlock = function() { return ecCodewordsPerBlock; }

    this.getECBlocks = function() { return ecBlocks; }
    ...
    this.getTotalECCodewords = function() {
        return ecCodewordsPerBlock * this.getNumBlocks();
    }
}
...
function Version(versionNumber, alignmentPatternCenters, ecBlocks1, ecBlocks2, ecBlocks3, ecBlocks4) {
    ...
    var ecBlocks = [ ecBlocks1, ecBlocks2, ecBlocks3, ecBlocks4 ];
    ...
    this.getVersionNumber = function() { return versionNumber; }

    this.getAlignmentPatternCenters = function() { return alignmentPatternCenters; }

    this.getTotalCodewords = function() { return totalCodewords; }

    this.getDimensionForVersion = function() { return 17 + 4 * versionNumber; }

    this.getECBlocksForLevel = function(ecLevel) { return ecBlocks[ecLevel.ordinal()]; }
    ...
    this.toString = function() { return ''+versionNumber; }
